...
Tujuan: menyimpan cukup konteks ke `HANDOFF.md` supaya sesi berikutnya bisa lanjut TANPA membaca ulang seluruh riwayat. Ini teknik hemat token paling berdampak.

Langkah:
1. Kalau `HANDOFF.md` belum ada, buat dari `${CLAUDE_PLUGIN_ROOT}/templates/HANDOFF.md.tmpl`.
...
4. Kalau `$ARGUMENTS` mengandung `progress`, update juga `PROGRESS.md`.
5. Setelah menulis, sarankan user menjalankan `/clear` lalu memulai sesi baru dengan membaca `HANDOFF.md`.
